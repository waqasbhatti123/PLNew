...
namespace RMS.BL
{
    public class InvSettlementBL
    {
        public InvSettlementBL()
        { }
        ...
        public object GetAllBillByVendorID(string vendorId, RMSDataContext Data)
        {
            ...
            try
            {
                var recs = from a in Data.tblBills
                           where a.IV_Status == "OP" && (a.IV_Type == "21" || a.IV_Type == "1") && a.PartyID == vendorId
                           select new
                           {
                               a.vrid,
                               IV_NO = a.IV_Type == "1" ? "JV-"+ a.IV_NO.Value.ToString() : a.IV_NO.Value.ToString() ,
                               a.IV_Date,
                               a.IV_Due_Date,
        ...
        public object GetAllPaymentsByVendorID(string vendorId, RMSDataContext Data)
        {
            ...
            try
            {
                var obj = from a in Data.tblSettlements
                          ...
                          where a.Status == "OP" && a.PartyId == vendorId && (b.vt_cd == 2 || b.vt_cd == 3)
                          select new
                          {
                              a.TransNo,
                              a.TransGlId,
