<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="frmBankSalaryTransfer.aspx.cs" Inherits="RMS.report.rdlc.frmBankSalaryTransfer"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredsearchBranchDropDown" runat="server" ControlToValidate="searchBranchDropDown"
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-4">
                                <label>Type</label>
                             <asp:DropDownList ID="ddlJobType" runat="server" CssClass="form-control employeeType"  AppendDataBoundItems="True" OnSelectedIndexChanged="ddlJobType_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <asp:Button ID="btnExcel" CssClass="btn btn-sucess" runat="server" Text="Report In Excel"
                                    OnClick="btnGenerate_Excel" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
