...
{
    public partial class EmpAcrRecordDetail : System.Web.UI.Page
    {
...
#pragma warning disable CS0114 // 'EmpAcrRecordDetail.ID' hides inherited member 'Page.ID'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        public int ID
#pragma warning restore CS0114 // 'EmpAcrRecordDetail.ID' hides inherited member 'Page.ID'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        {
        ...
        protected void PrintFunction(int empID)
        {
            ...
            acr = pro.GetEmpAcrRecord(empID, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
