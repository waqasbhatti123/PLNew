<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="DeptWiseSalaryReport.aspx.cs" Inherits="RMS.report.rdlc.DeptWiseSalaryReport"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4" style="margin-top:25px;">
                            <asp:Button ID="btnGenerat" runat="server" CssClass="btn btn-primary" Text="Report" 
