...
{
    public partial class SalaryTransferBankReport : System.Web.UI.Page
    {
        ...
        {
            IQueryable<spSalaryTransferBankResult> sal;
            sal = SalBl.RptSalTransferBank(CompId, PayPerd, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
        ...
        protected void btnGenerat_Click(object sender, EventArgs e)
        {
            ...
            CreatePDF("BankTransfer", ddlExport.Text);
        }
