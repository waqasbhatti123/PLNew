...
{
    public partial class DeptWiseSalaryReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "DeptWiseSalaryRpt").ToString();
        ...
        // Setup the report viewer object and get the array of bytes
            ...
            object sal;
            sal = rptBL.GetDeptWiseSalary(CompId, PayPerd, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);

            viewer.LocalReport.ReportPath = "report/rdlc/rptDeptWiseSalary.rdlc";
            ReportDataSource datasource = new ReportDataSource("spDeptWiseSalaryResult", sal);
           ...
           // ReportParameter prm = new ReportParameter("rpt_Prm_PayPeriod", ddlPayPerd.SelectedItem.Text);
            ...
            {
                paramz[2] = new ReportParameter("UserName", Request.Cookies["uzr"]["UserName"].ToString(), false);
            }
            else
            {
                paramz[2] = new ReportParameter("UserName", Session["UserName"].ToString(), false);
            }
        ...
        protected void btnGenerat_Click(object sender, EventArgs e)
        {
            ...
            CreatePDF("DeptWiseSalaryReport");
        }
