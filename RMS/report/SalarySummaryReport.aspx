<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true" 
    CodeBehind="SalarySummaryReport.aspx.cs" Inherits="RMS.report.SalarySummaryReport"
       Title="Salary Summary Report" Culture="auto" UICulture="auto" EnableEventValidation="true" %>
                ...
                <div class="card card-shadow mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <label>Type</label>
                             <asp:DropDownList ID="ddlemploye" runat="server" CssClass="form-control employeeType" OnSelectedIndexChanged="ddlEmploye_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="true">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <asp:Panel ID="pnlMain" runat="server" Width="100%" Height="600">
