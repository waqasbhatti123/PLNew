...
{
    public partial class SalaryEOBIReport : System.Web.UI.Page
    {
        ...
        protected void Load_report()
        {
            ...
            viewer.LocalReport.ReportPath = "report/rdlc/rptSalaryEOBI.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "SalaryEOBIReport").ToString();
                int iCompid;
