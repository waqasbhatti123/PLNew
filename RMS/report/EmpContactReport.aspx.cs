...
namespace RMS.report
{
    public partial class EmpContactReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "empcontact").ToString();
        ...
        protected void Report_Click(object sender, EventArgs e)
        {
            ...
            if (type == 0)
            {
                ...
                //string ddldropName = (ddldropdown.SelectedIndex).ToString();
                ...
                con = empBL.getAllEmployeeForReport(brI, desgID, secID, fromscale, toscale, jobType, fromage, toage, domicile,
                ...
                viewer.LocalReport.ReportPath = "report/rdlc/rpttAllEmpContactExcel.rdlc";
                ...
                paramz[1] = new ReportParameter("colum", ddlrop);
            ...
            else if(type == 1)
            {
                ...
                List<sp_Profiledbo> con;
                con = empBL.getContact(brI, desgID, secID, fromscale, toscale, jobType, fromage, toage, domicile,
                    Gender, disability, Religion, addtional, quota, poli, SortOrder, appointed, ddldrop, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);


                //viewer.LocalReport.ReportPath = "report/rdlc/AttenReport.rdlc";
                viewer.LocalReport.ReportPath = "report/rdlc/EmpContactExcel.rdlc";
                ReportDataSource datasource = new ReportDataSource("DataSet1", con);
                ReportParameter[] paramz = new ReportParameter[2];
                paramz[0] = new ReportParameter("LogoPath", rptLogoPath);
                paramz[1] = new ReportParameter("colum", ddlrop);
            ...
            else
            {
                ...
                //viewer.LocalReport.ReportPath = "report/rdlc/AttenReport.rdlc";
                viewer.LocalReport.ReportPath = "report/rdlc/rpttEmpRelievingExcell.rdlc";
                ReportDataSource datasource = new ReportDataSource("DataSet1", con);
                ReportParameter[] paramz = new ReportParameter[2];
                paramz[0] = new ReportParameter("LogoPath", rptLogoPath);
                paramz[1] = new ReportParameter("colum", ddlrop);
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            if (type == 0)
            {
                ...
                //viewer.LocalReport.ReportPath = "report/rdlc/AttenReport.rdlc";
                viewer.LocalReport.ReportPath = "report/rdlc/rpttAllEmpContact.rdlc";
                //viewer.LocalReport.ReportPath = "report/rdlc/PracticeMat.rdlc";
                ReportDataSource datasource = new ReportDataSource("DataSet1", con);
                ...
                //}
                paramz[0] = new ReportParameter("LogoPath", rptLogoPath);
                paramz[1] = new ReportParameter("colum", ddldrop.ToString());
                viewer.LocalReport.EnableExternalImages = true;
                viewer.LocalReport.Refresh();
                viewer.LocalReport.SetParameters(paramz);
                viewer.LocalReport.DataSources.Clear();
            ...
            else
            {
                if (type == 1)
                {
                    ...
                    //viewer.LocalReport.ReportPath = "report/rdlc/AttenReport.rdlc";
                    viewer.LocalReport.ReportPath = "report/rdlc/rpttEmpContact.rdlc";
                    //viewer.LocalReport.ReportPath = "report/rdlc/PracticeMat.rdlc";
                    ReportDataSource datasource = new ReportDataSource("DataSet1", con);
