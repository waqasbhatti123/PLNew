...
{
    public partial class SalarySSIReport : System.Web.UI.Page
    {
        ...
        protected void Load_report()
        {
            ...
            //sal = sal.Where(t => t.gross <= 10000);
            
            ReportViewer viewer = new ReportViewer();
            viewer.LocalReport.ReportPath = "report/rdlc/rptSalarySSI.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "SalarySSIReport").ToString();
                int iCompid;
        ...
        //    ReportViewer viewer =new ReportViewer();
            ...
            IQueryable<spSalaryListResult> sal;
            sal = SalBl.rptEmpListEOBI(CompId, PayPerd, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            sal = sal.Where(t => t.scsienb==true);
