...
{
    public partial class DeveBudget : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                    ...
                    Session["PageTitle"] = "Development Budget";
        ...
        private void FillSearchBranchDropDown()
        {
            ...
            this.dlladpScheme.DataTextField = "title";
            this.dlladpScheme.DataValueField = "ADID";
            this.dlladpScheme.DataSource = db.tblADPSchemes.Where(x => x.isActive == true).ToList();
            this.dlladpScheme.DataBind();
            this.dlladpScheme.Items.Insert(0, new ListItem("Select Scheme", "0"));
        }
        ...
        {
            return new BudgetBL().GetDeevBudget((RMSDataContext)HttpContext.Current.Session[HttpContext.Current.Session["UserID"] + "rmsDBObj"], BudgetTypeID, Financialyear,1 ,brID);
        }
        ...
        public static string SaveBudget(List<RMS.BL.Budget> budget)
        {
            ...
            {
                BudgetBL budgetBL = new BudgetBL();
                int schme = Convert.ToInt32(budget[0].SchemeID);
                
                string Chk = budgetBL.SubmitDeveBud(Financialyear, BudgetTypeID,1,budget,schme,(RMSDataContext)HttpContext.Current.Session[HttpContext.Current.Session["UserID"] + "rmsDBObj"]);
                if (Chk == "OK")
                {
