...
{
    public partial class SNEAvsAllocation : System.Web.UI.Page
    {
        ...
        public static string SaveBudget(List<RMS.BL.Budget> budget)
        {
            try
            {
                ...
                string Chk = budgetBL.SubmitAllocation(Financialyear, 4, brId, budget, (RMSDataContext)HttpContext.Current.Session[HttpContext.Current.Session["UserID"] + "rmsDBObj"]);
                if (Chk == "OK")
                {
