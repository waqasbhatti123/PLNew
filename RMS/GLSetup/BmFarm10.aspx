<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="BmFarm10.aspx.cs" Inherits="RMS.GLSetup.BmFarm10"
            ...
            <div class="card card-shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <label>Increment Date*</label><span class="DteLtrl">
                            ...
                            <ajaxToolkit:CalendarExtender ID="txtFromCal" runat="server" TargetControlID="txtfrom" Enabled="True">
                            </ajaxToolkit:CalendarExtender>
                        </div>
                        <br />
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <asp:Button Text="Report" ID="btnSave1" CssClass="btn btn-primary" OnClick="btnFrom10_Save" runat="server" Style="margin-top:25px" />
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
