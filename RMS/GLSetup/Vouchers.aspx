...
CodeBehind="Vouchers.aspx.cs" Culture="auto" UICulture="auto" 
Inherits="RMS.GLSetup.Vouchers" %>
    ...
    function pageLoad() {
        ...
        $("[id*=grdView]input[type=text][id*=txtcode]").autocomplete({
            ...
            select: function(e, ui) {
                ...
                $(e.target).closest('tr').find("input[type=text][id*=txtBalance]").val(ui.item.balance);
       ...
       function getFirstRowCode() {
            ...
            $.ajax({
                ...
                success: function(heads) {
                    var head = heads.d;
                    if (head.length > 0) {
                        $('#<%=grdView.ClientID%> tr:nth-child(3) ').find("input[type=text][id*=txtcode]").val(glCd);
                        $('#<%=grdView.ClientID%> tr:nth-child(3) ').find("input[type=text][id*=txtdescription]").val(head);
                    }
                }
            });
        }
            ...
            <div class="card-body"> 
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <asp:TextBox ID="txtnarration" runat="server" CssClass="form-control" TextMode="MultiLine" onkeyup="LimitText(this,250);" onblur="LimitText(this,250);"/>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <label>Source*</label>
                            <asp:DropDownList ID="ddlSource" runat="server" CssClass="form-control" AppendDataBoundItems="True">
                             </asp:DropDownList>
                        </div>
                    </div>
				</div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <asp:TextBox ID="txtRefSource" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <asp:Label ID="lblNtnNum" Text="NTN / ID Card Number" runat="server"></asp:Label>
                                <asp:TextBox ID="txtNtnNumbere" CssClass="form-control" runat="server" MaxLength="1000"></asp:TextBox>
                            </div>
                        </div>
				    </div>
                </div>
                         ...
                         <asp:GridView runat="server" ID="grdView" ShowFooter="True" OnRowDataBound ="grdView_RowDataBound" AutoGenerateColumns="false" class="table table-responsive-sm" Width="100%"  >
                          ...
                          <Columns>
                            ...
                            <asp:TemplateField HeaderText="#">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtseq"  Text='<%#Eval("seq") %>' ReadOnly="true" TabIndex="-1" Width="20px" Font-Size="15px"></asp:TextBox>
                             </ItemTemplate>
                             <ControlStyle />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="GL Code">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtcode" Text='<%#Eval("code") %>' Width="70px" Font-Size="15px"></asp:TextBox>
                             </ItemTemplate>
                             <ControlStyle />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Description">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtdescription" Text='<%#Eval("desc") %>' TabIndex="-1" Width="200px" Font-Size="15px"></asp:TextBox>
                             </ItemTemplate>
                             <ControlStyle />
                            ...
                            <asp:TemplateField HeaderText="Debit" >
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtdebit" Text='<%#Eval("debit") %>' Width="70px" Font-Size="15px" style="text-align:right"></asp:TextBox>
                             </ItemTemplate>
                             <FooterTemplate> 
                              <asp:Label ID="lbldebit" runat="server" style="text-align:right" Font-Size="15px"></asp:Label>
                             </FooterTemplate>
                             <ControlStyle />
                             <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Credit">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtcredit" Text='<%#Eval("credit") %>' Width="70px" Font-Size="15px" style="text-align:right"></asp:TextBox>
                             </ItemTemplate>
                             <FooterTemplate> 
                              <asp:Label ID="lblcredit" runat="server" style="text-align:right" Font-Size="15px"></asp:Label>
                             </FooterTemplate>
                             <ControlStyle />
                             <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                             <FooterStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                            ...
                            <asp:TemplateField HeaderText="Remarks">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtremarks" Text='<%#Eval("remark") %>' Width="90px" Font-Size="15px"></asp:TextBox>
                             </ItemTemplate>
                             <FooterTemplate> 
                              <%--<asp:Label ID="lblbalance" runat="server"  style="text-align:center" Font-Size="15px"></asp:Label>--%>
                             </FooterTemplate>
                             <ControlStyle />
                             <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                             <FooterStyle VerticalAlign="Middle" HorizontalAlign="Right" />
                            ...
                            <asp:TemplateField HeaderText="Cost Center">
                             <ItemTemplate>
                              <asp:DropDownList runat="server" ID="ddlcostcenter" AppendDataBoundItems="true" Width="180px"  Font-Size="15px">
                            ...
                            <asp:TemplateField HeaderText="Remaining">
                             <ItemTemplate>
                              <asp:TextBox runat="server" ID="txtBalance" Text='<%#Eval("balance") %>' Width="70px" Font-Size="15px" style="text-align:right" ReadOnly="true"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    Width="100%" PageSize="20" OnPageIndexChanging="grdVoucher_PageIndexChanging" CssClass="table table-responsive-sm"
                     EmptyDataText="No voucher found.">
                        <Columns>
                                <asp:BoundField DataField="vrid"  ItemStyle-CssClass="DisplayNone" ControlStyle-CssClass="DisplayNone" />
                                ...
                                <asp:BoundField DataField="headsInvolved" HeaderText="Head Code" />
