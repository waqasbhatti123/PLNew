...
{
    public partial class ApprovedBudget : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                 ...
                 if (BudgetTypeID == 2)
                {
                    Session["PageTitle"] = "Approved Budget";
                }
                else { }
        ...
        //protected void GoReport_click(object sender, EventArgs e)
        //{
        //    Response.Redirect("ApprovedBudgetReport.aspx");
        //}
