    ...
    public partial class BudgetReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "budgetreport").ToString();
               ...
               // Request.QueryString["PID"] = PID.ToString();
        ...
        protected void CreatePDF(String FileName)
        {
            ...
            var finn = db.FIN_PERDs.Where(x => x.Cur_Year == "CUR").FirstOrDefault();
