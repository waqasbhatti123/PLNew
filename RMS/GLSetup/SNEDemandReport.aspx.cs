...
{
    public partial class SNEDemandReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "SneDemand").ToString();
        ...
        protected void CreatePDF(String FileName)
        {
            ...
            IQueryable<SNEBudgetResult> sal;
            sal = Sne.GetSneData(exactyear,(RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);

            viewer.LocalReport.ReportPath = "glsetup/rdlc/rptSNEDemand.rdlc";
