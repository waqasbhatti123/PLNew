...
{
    public partial class MonthlyCCAcDet : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "MonthlyCCDetail").ToString();
                ...
                txtFromDate.Text = Convert.ToDateTime(dt).
                ...
                txtToDate.Text = Common.MyDate((RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]).Date.
                    ToString(System.Configuration.ConfigurationManager.AppSettings["DateFormat"]);
        ...
        private void GenerateReport()
        {
            ...
            List<sp_GL_Ledger_CC_DetailResult> cc;
            cc = new CCBL().GetCCDetailLedgher(BrID, Convert.ToDecimal(ddlGlYear.SelectedValue), Convert.ToDateTime(txtFromDate.Text),
            ...
            viewer.LocalReport.ReportPath = "GLSetup/rdlc/rptCCLedgerDetail.rdlc";
            ReportDataSource datasource = new ReportDataSource("sp_GL_Ledger_CC_DetailResult", cc);
