<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="WetBlueTrnsfrMgt.aspx.cs" Inherits="RMS.WetBlueTrnsfrMgt" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td>
                        ...
                        <asp:Panel runat="server" ID="Panel1">
                            ...
                            <tr>
                                ...
                                <td>
                                         <asp:DropDownList ID="ddlDesign" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlDesign_SelectedIndexChanged" CssClass="RequiredFieldDropDown" >
                             ...
                             <tr>
                                ...
                                <td>
                                        ...
                                        <asp:DropDownList ID="ddlColor" runat="server" AppendDataBoundItems="true" Enabled="false" CssClass="RequiredFieldDropDown">
                               ...
                               <tr>
                                <td  class="LblBgSetup">
                                        <asp:Label ID="lblQty" runat="server"  Text="Transfer Full Piece:">
                                        </asp:Label>
                                </td>
                                <td>
                                        <asp:TextBox ID="txtQty" runat="server" width="74px" BackColor="#F2F2F2" BorderStyle="solid" BorderWidth="1" BorderColor="ActiveBorder" CssClass="classOnlyInt" MaxLength="6">
                                          </asp:TextBox>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="upnlDDL2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                
                                     <asp:DropDownList ID="ddlThickness" runat="server" AppendDataBoundItems="true" Enabled="false" CssClass="RequiredFieldDropDown">
                                        <asp:ListItem Text="" Selected="True" Value="0">
                                        </asp:ListItem>
                                        </asp:DropDownList>
                              ...
                              <tr>
                                <td  class="LblBgSetup">
                                    <asp:Label ID="Label2" runat="server"  Text="Transfer Half Piece:">
                                        </asp:Label>
                                </td>
                                <td>
                                        <asp:TextBox ID="txtHalfQty" runat="server" width="74px" BackColor="#F2F2F2" BorderStyle="solid" BorderWidth="1" BorderColor="ActiveBorder" CssClass="classOnlyInt" MaxLength="6">
                                          </asp:TextBox>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <td>
          ...
          <uc1:Messages ID="QtyMessage" runat="server" />
          <br />
  
      <asp:GridView ID="GridView1" runat="server"  Width="55%" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
      ...
      <Columns>
        ...
        <asp:TemplateField HeaderText="Full Piece*"  FooterStyle-HorizontalAlign="Right"   ControlStyle-Width="80px" HeaderStyle-Width="80px" >
        <ItemTemplate>
        <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Eval("Quantity")%>' CssClass="classAlign" OnTextChanged="txtQuantity_textChanged" AutoPostBack="true" MaxLength="6"/>
        </ItemTemplate>
        <FooterTemplate>
        ...
        <asp:TemplateField HeaderText="Half Piece*"  FooterStyle-HorizontalAlign="Right"   ControlStyle-Width="80px" HeaderStyle-Width="80px" >
        <ItemTemplate>
        <asp:TextBox ID="txtHalfQuantity" runat="server" Text='<%#Eval("HalfQuantity")%>' CssClass="classAlign" OnTextChanged="txtHalfQuantity_textChanged" AutoPostBack="true" MaxLength="6" />
        </ItemTemplate>
        <FooterTemplate>
        <asp:Label ID="lblGrossHalfQuantityTotal" runat="server" Text="0"></asp:Label>
         ...
         <asp:TemplateField HeaderText="Avg. Sqft"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" ControlStyle-Width="80px">
          <ItemTemplate>
