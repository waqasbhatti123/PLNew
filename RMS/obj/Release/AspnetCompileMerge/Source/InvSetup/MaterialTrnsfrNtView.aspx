<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="MaterialTrnsfrNtView.aspx.cs" Inherits="RMS.MaterialTrnsfrNtView" %>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
         ...
         <fieldset class="fieldSet">
                        ...
                        <td width="80px">
                            <asp:TextBox ID="txtLotNo" runat="server" ReadOnly="true"  CssClass="RequiredFieldTxtSmall">
                            </asp:TextBox>
...
<div style="height:20px"></div>
  ...
  <asp:Panel ID="srchPanel" HorizontalAlign="Center" Width="100%" runat="server" Visible="false">
    ...
    <asp:GridView ID="grdSGC" DataKeyNames="vr_apr" runat="server" Enabled="false"
  ...
  <ContentTemplate>
    ...
    <asp:GridView ID="GridView1" runat="server"  Width="50%" Enabled="false" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
      <HeaderStyle CssClass ="grid_hdr" />
                    <RowStyle CssClass="grid_row" />
                    <AlternatingRowStyle CssClass="gridAlternateRow" />
                    <SelectedRowStyle CssClass="gridSelectedRow" />
      ...
      <asp:Label runat="server" ID="lblSr" Text='<%#Eval("Sr") %>' Width="30px" BackColor="White">
        ...
        <ItemTemplate>
        <asp:TextBox ID="txtLotRef" runat="server"  Text='<%#Eval("LotRef") %>' CssClass="classOnlyInt">
        </asp:TextBox>
        </ItemTemplate>
        </asp:TemplateField>
...
<ItemTemplate></ItemTemplate>
        ...
        <ItemTemplate>
        <asp:TextBox ID="txtDrumNo" runat="server"  Text='<%#Eval("DrumNo") %>'>
        </asp:TextBox>
        </ItemTemplate>
        <FooterTemplate>
