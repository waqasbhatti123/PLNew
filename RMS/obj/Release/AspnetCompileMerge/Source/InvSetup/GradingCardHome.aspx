<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="GradingCardHome.aspx.cs" Inherits="RMS.GradingCardHome" %>
...
<script type="text/javascript">
    function promptFunc() {
        return confirm("Are your sure that you want to cancel this Grading Card?");
    }
    function promptFunc1() {
        return confirm("Are your sure that you want to approve this Grading Card?");
    }
</script>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <td>
  &nbsp;  &nbsp;  
  <asp:LinkButton ID="linkBtnSearch" runat="server" Text="Search Card" OnClick="btnSearch_Click" ForeColor="Black" ></asp:LinkButton>
 ...
 <div>
 <br />
<%-- <asp:Button ID="btnCreateSGC" runat="server" OnClick="btnCreateSGC_Click" Text="Create Card"/>--%>

 <asp:ImageButton ID="btnCreateSGC" runat ="server" OnCommand="btnCreateSGC_Click" ImageUrl="~/images/btn_generate.png"
 ...
 <br />
  <p>
        ...
        <HeaderStyle CssClass ="grid_hdr" />
            ...
            <Columns>
                <asp:BoundField DataField="vr_no" HeaderText="Grading No" />
                
                <asp:BoundField DataField="LotNo" HeaderText="Lot No" />
                <asp:BoundField DataField="vr_dt" DataFormatString= "{0:dd-MMM-yy}" htmlencode="false" HeaderText="Grading Date" />
                <asp:BoundField DataField="status" HeaderText="Status" />
                <asp:TemplateField HeaderText="Options"  HeaderStyle-Width="150px">
                
                    <ItemTemplate>
                        <asp:Label ID="lbl" runat="server"  Visible="false" Text='<%# Bind("LotNo") %>'>'></asp:Label>
