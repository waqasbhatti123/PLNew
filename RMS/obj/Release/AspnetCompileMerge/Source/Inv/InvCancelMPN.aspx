<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="InvCancelMPN.aspx.cs" Inherits="RMS.Inv.InvCancelMPN" %>
...
<script type="text/javascript" language="javascript">
    ...
    function prompt4Cancel() {
        return confirm("Are your sure, you want to cancel MPN?");
    }
</script>
        ...
        <tr>
           ...
           <td>                         
            <asp:TextBox ID="txtDue" runat="server" style="text-align:right;" TabIndex="-1" Width="120px">
              ...
              <td> 
                    <asp:ImageButton ID="btnCancel" runat="server"  ImageUrl="~/images/btn_cancel.png" OnClick="btnCancel_Click" OnClientClick="return prompt4Cancel()"
                        onMouseOver="this.src='../images/btn_cancel_m.png'" onMouseOut="this.src='../images/btn_cancel.png'" ValidationGroup="main" />
      ...
      <td width="1%">
          ...
          <td>
                  ...
                  <tr>
                    ...
                    <td>Status:</td>
                    <td>
                        <asp:DropDownList ID="ddlFltType" runat="server" Enabled="false">
