<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="MonthlyReconReport.aspx.cs" Inherits="RMS.report.MonthlyReconReport"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4" style="margin-top:25px">
                             <asp:Button ID="btnGenerat" CssClass="btn btn-primary" runat="server" Text="Report" OnClick="btnGenerat_Click" />
                        </div>
                    </div>
                    &nbsp;
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <asp:Panel ID="pnlMain" runat="server" Width="99%" Height="600px">
