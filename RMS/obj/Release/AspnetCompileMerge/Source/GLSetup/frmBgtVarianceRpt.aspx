<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
 AutoEventWireup="true" CodeBehind="frmBgtVarianceRpt.aspx.cs" Inherits="RMS.GLSetup.frmBgtVarianceRpt"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <p>
      <asp:Label ID="lblFinYear" Text="Fin Year :" runat="server"/>
      &nbsp;
      <asp:DropDownList ID="ddlFinYear" runat="server" AppendDataBoundItems="True" Width="150px">
      </asp:DropDownList>
      &nbsp;
