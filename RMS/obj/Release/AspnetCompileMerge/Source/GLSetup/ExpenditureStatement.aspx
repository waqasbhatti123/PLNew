<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="ExpenditureStatement.aspx.cs" Inherits="RMS.GLSetup.ExpenditureStatement"
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".click").click(function () {
                window.open("ExpenditureStatementReport.aspx");
                location.reload();
            })
           ...
           // $('.searchbranchchange').val(brID);
            ...
            $.ajax({
                url: "ExpenditureStatement.aspx/SaveBudget",
        ...
        function getBudget(br_ID) {
            $.ajax({
                url: "ExpenditureStatement.aspx/bindGridJquery",
                ...
                success: function (data) {
                    ...
                    var sumOfEst = 0, sumOfCont = 0;

                    $.each(data.d, function (index, item) {

                        debugger

                        if (item.Account.includes('030101')) {
                            sumOfEst += item.Grant;
                        }
                        else if (item.Account.includes('030102')) {
                            sumOfCont += item.Grant;
                        }
                        else {}
                        ...
                        html += '<td><input type="number" class="form-control form-control-sm text-right grant" id="txtGrant" value="' + item.Expenditure + '" ParentAccount = "' + item.ParentCode + '"/></td>';
                        html += '</tr>';
    ...
    <div class="card">
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 offset-lg-6">
                ...
                <%--<div class="col-md-4">
                    ...
                    <input type="button" class="btn btn-lg btn-primary"  id="btnSave" value="Save Expenditure" />
                </div>--%>
            ...
            <div class="row grandTotal">
                ...
                <div class="col-lg-2">
                    ...
                    <asp:TextBox runat="server" CssClass="estab form-control" disabled="true"/>
                </div>
                <div class="col-lg-2">
                    <label>Contigencies</label>
                    <asp:TextBox runat="server" CssClass="cont form-control" disabled="true"/>
                </div>
                <div class="col-lg-2 offset-lg-1">
                    <label>Total Expenditure</label>
                  <input type="text" class=" text-right form-control grandTotalValGrant"  readonly="readonly"/>
                  </div>
