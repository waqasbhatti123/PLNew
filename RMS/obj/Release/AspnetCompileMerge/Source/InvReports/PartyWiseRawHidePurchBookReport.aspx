<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="PartyWiseRawHidePurchBookReport.aspx.cs" Inherits="RMS.PartyWiseRawHidePurchBookReport" %>
...
<br />
<asp:RadioButton ID="rdbMonthWiseYear" runat="server" GroupName="sort" Text=" Month-Wise Financial Year" AutoPostBack="true" OnCheckedChanged="rdbMonthWiseYear_Changed" Width="200px"/>
<br />
   <asp:RadioButton ID="rdbMonth" runat="server" GroupName="sort" Text=" Month (Detail)" AutoPostBack="true" OnCheckedChanged="rdbMonth_Changed" Width="200px"/>
 <br />
   <asp:RadioButton ID="rdbMonthly" runat="server" GroupName="sort" Text=" Month" AutoPostBack="true" OnCheckedChanged="rdbMonthly_Changed" Width="200px"/>
  
  <%--<br />
   <asp:RadioButton ID="rdbVendor" runat="server" GroupName="sort" Text=" Broker-Wise Yearly Report" AutoPostBack="true" OnCheckedChanged="rdbVendor_Changed" Width="200px"/>
   <br />
   <asp:RadioButton ID="rdbVendorYr" runat="server" GroupName="sort" Text=" Broker-Wise Monthly Report" AutoPostBack="true" OnCheckedChanged="rdbVendorYr_Changed" Width="200px"/>--%>
