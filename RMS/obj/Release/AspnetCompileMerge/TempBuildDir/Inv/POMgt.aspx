<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="POMgt.aspx.cs" Inherits="RMS.Inv.POMgt" Culture="auto" UICulture="auto"
                                        ...
                                        <asp:GridView ID="GridView1" runat="server"  CssClass="t_grd" Width="100%" AutoGenerateColumns="false" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true">
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="Item*">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtItem" runat="server" Text='<%#Eval("Item") %>' Width="90px" />
                                                </ItemTemplate>
                                                <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                             ...
                                             <asp:TemplateField HeaderText="UOM">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtUomItem" runat="server" Text='<%#Eval("UOM") %>'  Width="30px" TabIndex="-1" />
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                              ...
                                              <asp:TemplateField HeaderText="Req Qty">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtPoQuantity" runat="server" Text='<%#Eval("PoQuantity")%>' style="text-align:right;" MaxLength="9" TabIndex="-1"  Width="50px"/>
            ...
            <td valign="top">
                ...
                <table class="filterTable" width="70%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblFltName" runat="server" Text="PO No:"></asp:Label>
                            <asp:TextBox runat="server" ID="txtFltPoNo" Width="100"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label22" runat="server" Text="Party:"></asp:Label>
                ...
                OnRowDataBound="grdPo_RowDataBound"
                    AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No PO found" Width="100%">
                    <Columns>
