<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"  AutoEventWireup="true"
 CodeBehind="frmReportParameter_Old.aspx.cs" Culture="auto" UICulture="auto" 
 EnableEventValidation="true"Inherits="RMS.GL.Setup.frmReportParameter_Old" %>
  ...
  <asp:ValidationSummary ID="main" CssClass="ErrorSummary" runat="server" DisplayMode="List"
    ...
    <div>
       ...
       <asp:TemplateField HeaderText="OL" HeaderStyle-Width="15px">
        ...
        <asp:TemplateField HeaderText="From CC" HeaderStyle-Width="75px">
            <ItemTemplate>
                ...
                <ajaxToolkit:AutoCompleteExtender runat="server" ID="ACFromCC" TargetControlID="txtFromCC" ServiceMethod="GetCostCenter" ServicePath="~/InvSetupSupport/AutoCompleteSearch.asmx" MinimumPrefixLength="1"
                        CompletionSetCount="5" CompletionInterval="100" FirstRowSelected="true" EnableCaching="true" ></ajaxToolkit:AutoCompleteExtender>
            </ItemTemplate>
        </asp:TemplateField>  
