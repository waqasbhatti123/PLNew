<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="DistGrntAmounAllCouReport.aspx.cs" Inherits="RMS.GLSetup.DistGrntAmounAllCouReport"
            ...
            <div class="card card-shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <label>Select</label>
                    <asp:DropDownList ID="GrantSelect" runat="server" CssClass="form-control searchbranchchange" 
                        AppendDataBoundItems="True">
                        <asp:ListItem Value="0">Annual Grant</asp:ListItem>
                        <asp:ListItem Value="1">Half Grant</asp:ListItem>
                        <asp:ListItem Value="2">Quarterly Grant</asp:ListItem>
                    </asp:DropDownList>
                        </div>
