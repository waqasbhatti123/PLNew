<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="ExcessSsurrender.aspx.cs" Inherits="RMS.GLSetup.ExcessSsurrender"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                url: "ExcessSsurrender.aspx/SaveBudget",
                data: JSON.stringify({ excesses: accounts }),
                dataType: "json",
                type: "POST",
        ...
        function getBudget(br_ID) {
            $.ajax({
                url: "ExcessSsurrender.aspx/bindGridJquery",
                ...
                success: function (data) {
                    ...
                    $.each(data.d, function (index, item) {
                        ...
                        html += '<td class="glds">' + item.Gldsc + '</td>';
                        html += '<td><input type="number" class="form-control form-control-sm text-right txtGrant" disabled="true" id="txtGrant" style="width:120px" value="' + item.AppBudget + '"/></td>';
                        ...
                        html += '<td><input type="number" class="form-control form-control-sm text-right txtcurrentfinancia" id="txtcurrentfinancia" style="width:120px" value="' + item.fourMonthExpCurrentFinancialYear + '"/></td>';
                        html += '<td><input type="number" class="form-control form-control-sm text-right txtprevious" id="txtprevious" style="width:120px" value="' + item.eightmonthpreviousFinancialYear + '"/></td>';
        ...
        //    });
        //                    $("#myBody [id^=modified]").each(function () {
        ...
        //                });
        //                    Val1 = parseFloat(valGrant) + parseFloat(valModi);
        //        $(".modified").val(Val1);
                ...
                <table id="myTable" class="table table-responsive table-sm">
                    <thead>
                        ...
                        <th>Original Budget
                            ...
                            <th>
                                Actual Expenditure for first 4 month of Current Financial Year
                            </th>
                            <th>
                                Actual Expenditure for last 8 month of Previous Financial Year
                            </th>
                            <th>
                                Total Actual
                            </th>
