<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="DeveBudget.aspx.cs" Inherits="RMS.GLSetup.DeveBudget"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.adpchange').change(function () {

                var Br_ID = $('.adpchange').val();
                getBudget(Br_ID);
            ...
            $('#btnSave').click(function () {
                ...
                $('.clAccount').each(function (index, item) {
                    ...
                    var push = accounts.push({ Account: accountId, Grant: grantid, SchemeID: scheme });
                    if (push) {
                        var $tr = $(this).closest('tr');
                    var Incomeid = $tr.find('.income').val("");
                    var grantid = $tr.find('.grant').val("");
            ...
            $.ajax({
                url: "DeveBudget.aspx/SaveBudget",
        ...
        function getBudget(br_ID) {
            $.ajax({
                url: "DeveBudget.aspx/bindGridJquery",
    ...
    <div class="card">
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <label>Schemes:</label>
                    <asp:DropDownList ID="dlladpScheme" runat="server"  CssClass="form-control adpchange" 
