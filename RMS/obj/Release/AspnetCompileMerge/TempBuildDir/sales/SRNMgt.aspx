<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="SRNMgt.aspx.cs" Inherits="RMS.sales.SRNMgt" Culture="auto" UICulture="auto"
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="100%">
                            ...
                            <asp:ImageButton ID="btnSrchDoc" runat="server" ImageUrl="~/images/search-icon-blue.gif"
                                OnClick="btnSrchDoc_Click" ToolTip="Search production transfer note"/>
                            <br />
            ...
            <td>
                <table class="tblMain" cellspacing="0" cellpadding="0">
                    <asp:Panel runat="server" ID="pnlMain">
                        <tr>
                            <td class="tdlabel">
                                <asp:Label ID="Label1" runat="server" Text="PTN No:"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtPTNNo" runat="server" ReadOnly="true"  Width="80px" TabIndex="-1">
                                </asp:TextBox>
                            </td>
                            <td class="tdlabel">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLoc" runat="server" Enabled="false" TabIndex="-1" AppendDataBoundItems="true">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="t_grd" OnRowDataBound="GridView1_RowDataBound">
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="Item">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlItem" runat="server" Enabled="false" TabIndex="-1" AppendDataBoundItems="true" CssClass="classDdlItem" Width="200px">
                                              ...
                                              <asp:TemplateField HeaderText="Batch">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtBatch" runat="server" ReadOnly="true" TabIndex="-1" Text='<%#Eval("Batch") %>' MaxLength="20" Width="60px"/>
                                              ...
                                              <asp:TemplateField HeaderText="UOM">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtUomItem" runat="server" ReadOnly="true" Text='<%#Eval("UOMItem") %>' TabIndex="-1" Width="50px"/>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                              ...
                                              <asp:TemplateField HeaderText="Transfer Quantity">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtTrnsfrQty" runat="server" ReadOnly="true" TabIndex="-1" Text='<%#Eval("TrnsfrQty") %>' Width="60px" style="text-align:right"/>
                                              ...
                                              <asp:TemplateField HeaderText="Received Quantity">
                                                  <ItemTemplate>
                                                    ...
                                                    <asp:RangeValidator runat="server" ID="rvRQ" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Invalid/Out of range Received Quantity"
                                                        ControlToValidate="txtRcvdQty" MinimumValue="0.00" MaximumValue="999999999.99" Type="Double" Display="Dynamic" SetFocusOnError="true"></asp:RangeValidator>
                                ...
                                <td colspan="4">
                                    <div style="float:right">
                                        <asp:UpdatePanel ID="updButPnl" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:LinkButton runat="server" ID="addRow" Text="Add Rows" Visible="false" OnClick="addRow_Click" CssClass="lnk"></asp:LinkButton>               
                                            </ContentTemplate>  
                                        </asp:UpdatePanel>
                                    </div>
                                </td>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <asp:GridView ID="grd" runat="server" DataKeyNames="vr_id, LocId, ptnvr_id"
                OnSelectedIndexChanged="grd_SelectedIndexChanged"
                 OnPageIndexChanging="grd_PageIndexChanging" OnRowDataBound="grd_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ptnvr_no" HeaderText="Doc Ref" />
