<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="MaterialPurchaseNoteMgt.aspx.cs" Inherits="RMS.MaterialPurchaseNoteMgt" %>
...
<tr>
 ...
 <ContentTemplate>
  ...
  <div  class="div">
    ...
    <asp:TextBox ID="txtLotNo" CssClass="RequiredFieldTxtSmall" runat="server" >
    </asp:TextBox>
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <asp:TextBox ID="txtCommission" runat="server" CssClass="classIntegers" Width="74px">
                                </asp:TextBox>
          ...
          <td width="3%">
                  ...
                  <td width="90%">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        ...
                        <asp:GridView ID="GridView1" runat="server"  Width="100%" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" >
                                        <HeaderStyle CssClass ="grid_hdr" />
                                        <RowStyle CssClass="grid_row" />
                                        <AlternatingRowStyle CssClass="gridAlternateRow" />
                                        <SelectedRowStyle CssClass="gridSelectedRow" />
