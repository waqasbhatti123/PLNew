<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="SizingGradingCardMgt1.aspx.cs" Inherits="RMS.SizingGradingCardMgt1" %>
            ...
            <td width="3%">
                ...
                <td>
                            ...
                            <fieldset class="fieldSet" >
                                  ...
                                  <asp:Label ID="lblSrch" runat="server" Text="IGP No:">
                                  </asp:Label>
                                  </td><td>
                                  <asp:TextBox ID="txtSrcIGP" runat="server" CssClass="RequiredField" Width="400px" Height="18px">
                                  </asp:TextBox>
                                  ...
                                  <asp:ImageButton runat="server" ID="imgIGP" OnClick="srchIGP_Click" CssClass="Clk" ToolTip="Search by IGP No." ImageUrl="../images/search_icon.png" />
                                    </td>
                                    ...
                                    <td width="620px">
                                      ...
                                      <asp:Panel ID="srchPanel" HorizontalAlign="Center" Width="100%" runat="server" Visible="false">
                                            ...
                                            <asp:GridView ID="grdIGP" DataKeyNames="Doc_Ref" runat="server" OnSelectedIndexChanging="grdIGP_SelectedIndexChanging"
                                                            ...
                                                            Width="100%" PageSize="10" OnPageIndexChanging="grdIGP_PageIndexChanging" >
                                                    <HeaderStyle CssClass ="grid_hdr" />
                                                    <RowStyle CssClass="grid_row" />
                                                    <AlternatingRowStyle CssClass="gridAlternateRow" />
                                                    <SelectedRowStyle CssClass="gridSelectedRow" />
                                                    <Columns>
                                                        <asp:BoundField DataField="vr_no" HeaderText="IGP No" ControlStyle-Width="74px" />
                                                        <asp:BoundField DataField="vr_dt" HeaderText="IGP Date"  ControlStyle-Width="74px"  DataFormatString="{0:dd-MMM-yyyy}" HtmlEncode="false" />
                                                        <asp:BoundField DataField="gl_dsc" HeaderText="Party"  ControlStyle-Width="200px"  />
                                                        <asp:BoundField DataField="vr_qty" HeaderText="Quantity"  ControlStyle-Width="40px"  />
                                                        <asp:BoundField DataField="vr_apr" HeaderText="Status"  ControlStyle-Width="40px" />
                                                        <asp:CommandField  ShowSelectButton="true" HeaderText="Card"  ControlStyle-Width="20px" />
            ...
            <td width="3%">
                ...
                <td>
                        ...
                        <asp:Panel runat="server" ID="pnlMain">
                            ...
                            <td   class="LblBgSetup">
                                <asp:Label ID="lblIgpDisp" runat="server" Text="IGP No:">
                                </asp:Label>
                            </td>
                            <td>
