<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="CrustDeptTrnsfrHome.aspx.cs" Inherits="RMS.CrustDeptTrnsfrHome" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <legend >
   ...
   <table width="60%" cellspacing="0" class="stats1" align="left">
  <tr>
  <td>
  ...
  <asp:DropDownList ID="ddlStatus" runat="server" Width="80px">
   ...
   <asp:ImageButton ID="imgBtnSearch" runat="server" ToolTip="Search Note" OnClick="btnSearch_Click" ImageUrl="../images/search-icon-blue.gif"/>
                ...
                <asp:TemplateField HeaderText="Options"  HeaderStyle-Width="150px">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="Label1" runat="server"  Visible="false" Text='<%# Bind("fromLoc") %>'>'></asp:Label>
                         ...
                         <asp:LinkButton ID="lnkCancelAfterApprove" runat="server"  Text="Cancel" Visible="false" OnClick="lnkCancelAfterApprove_Click" OnClientClick="return promptFunc()"></asp:LinkButton>
