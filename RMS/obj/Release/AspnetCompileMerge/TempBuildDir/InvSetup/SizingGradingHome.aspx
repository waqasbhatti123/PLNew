<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="SizingGradingHome.aspx.cs" Inherits="RMS.sizinggradinghome" %>
...
<script type="text/javascript">
    function promptFunc() {
        return confirm("Are your sure that you want to cancel this Size Grade Card?");
    }
    function promptFunc1() {
        return confirm("Are your sure that you want to approve this Size Grade Card?");
    }
</script>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <br />
        ...
        <asp:ImageButton ID="btnCreateSGC" runat="server"  ImageUrl="~/images/btn_generate.png" OnCommand="btnCreateSGC_Click"
 ...
 <br />
  <p>
        ...
        <HeaderStyle CssClass ="grid_hdr" />
            ...
            <Columns>
                <asp:BoundField DataField="vr_no" HeaderText="Card No" />
                ...
                <asp:BoundField DataField="Qty" HeaderText="Lot Quantity" />
                <asp:BoundField DataField="vr_dt" DataFormatString= "{0:dd-MMM-yy}" htmlencode="false" HeaderText="Card Date" />
