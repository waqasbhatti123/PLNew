<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master"
    AutoEventWireup="true" CodeBehind="Budget.aspx.cs" Inherits="RMS.GLSetup.Budget"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btnSave').click(function () {
                ...
                $('.clAccount').each(function (index, item) {
                    ...
                    var push = accounts.push({ Account: accountId, Income: Incomeid, Grant: grantid, Aid: perposedid, br_id: branchId });
                    if (push) {
                        var $tr = $(this).closest('tr');
                    var Incomeid = $tr.find('.income').val("");
                    var grantid = $tr.find('.grant').val("");
        ...
        function getBudget(br_ID) {
            $.ajax({
                url: "budget.aspx/bindGridJquery",
