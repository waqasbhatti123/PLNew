<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="InwardGatePassView.aspx.cs" Inherits="RMS.InvSetup.InwardGatePassView" %>
                    ...
                    <asp:Panel runat="server" ID="pnlMain" Enabled="false">
                       <%-- <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDocRef" runat="server" Visible="false" CssClass="RequiredFieldTxtSmall" ReadOnly="true">
                                </asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlVendor" runat="server" CssClass="RequiredFieldDropDownVendor" AppendDataBoundItems="true" >
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTotalQty" runat="server"  CssClass="RequiredField" Width="180">
                            </asp:TextBox>
                            ...
                            <td>
                                ...
                                <asp:UpdatePanel ID="uPnl" runat="server" UpdateMode="Conditional">
                                      <ContentTemplate>
                                        ...
                                        <asp:GridView ID="GridView1" Enabled="false" runat="server" Width="100%"  GridLines="None" EmptyDataRowStyle-ForeColor="Red" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
...
<asp:TemplateField></asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="IGP Ref*"  FooterStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px" ControlStyle-Width="100px">
                                          <ItemTemplate>
                                          <asp:TextBox ID="txtIGPRef" runat="server" Text='<%#Eval("IGPRef")%>'  />
                                          </ItemTemplate>
                                                   <FooterTemplate>
