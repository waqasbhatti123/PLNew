<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="DispatchView.aspx.cs" Inherits="RMS.DispatchView" %>
...
//        });
        ...
        $("[id*=GridView1]input[type=text][id*=txtPurQuantity]").each(function() {
            $(this).css('text-align', 'right');
        });
        $("[id*=GridView1]input[type=text][id*=txtPurArea]").each(function() {
            $(this).css('text-align', 'right');
        });
        $("[id*=GridView1]input[type=text][id*=txtHalfPurQuantity]").each(function() {
            $(this).css('text-align', 'right');
        });
    ...
    var totalPurQuantity = calculatepurquantity();
    $("span[id*=lblGrossPurQuantityTotal]").text(totalPurQuantity);
    function calculatepurquantity() {
        var totalPQty = 0;
        $("[id*=GridView1]input[type=text][id*=txtPurQuantity]").each(function() {
            temp = parseFloat($(this).val());
            if (isNaN(temp)) temp = 0;
            totalPQty = totalPQty + temp;
        });
        return totalPQty;
    }

    var totalhalfPurQuantity = calculatehalfpurquantity();
    $("span[id*=lblGrossPurQuantityHalfTotal]").text(totalhalfPurQuantity);
    function calculatehalfpurquantity() {
        var totalHalfPQty = 0;
        $("[id*=GridView1]input[type=text][id*=txtHalfPurQuantity]").each(function() {
            temp = parseFloat($(this).val());
            if (isNaN(temp)) temp = 0;
            totalHalfPQty = totalHalfPQty + temp;
        });
        return totalHalfPQty;
    }

    var totalPurArea = calculatePurArea();
    $("span[id*=lblGrossPurArea]").text(totalPurArea);
    function calculatePurArea() {
        var totalPAr = 0;
        $("[id*=GridView1]input[type=text][id*=txtPurArea]").each(function() {
            temp = parseFloat($(this).val());
            if (isNaN(temp)) temp = 0;
            totalPAr = totalPAr + temp;
        });
        return totalPAr;
    }
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <asp:Panel ID="pnlHead" runat="server" Width="92%" >
                  ...
                  <td>
                              ...
                              <tr>
                                        ...
                                        <td>
                                                ...
                                                <asp:DropDownList ID="ddlCustomer" runat="server" AppendDataBoundItems="true" CssClass="RequiredFieldDropDownVendor">
                                                <asp:ListItem Selected="True" Value="0">Select Customer</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="ddlCustomer" Display="None" InitialValue="0" ValidationGroup="main" ErrorMessage="Please select customer." SetFocusOnError="true"></asp:RequiredFieldValidator>
                              ...
                              <br />
                                ...
                                <asp:Panel runat="server" ID="Panel1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlItem" runat="server" AppendDataBoundItems="true" AutoPostBack="true" CausesValidation="true" CssClass="RequiredFieldDropDown" OnSelectedIndexChanged="ddlItem_SelectedIndexChanged">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                 <asp:DropDownList ID="ddlDesign" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlDesign_SelectedIndexChanged" CssClass="RequiredFieldDropDown" CausesValidation="true"  ValidationGroup="main" >
              ...
              <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  Width="50%" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound" EmptyDataText="No record found.">
                      ...
                      <Columns>
                        ...
                        <ItemTemplate>
                        <asp:TextBox ID="txtPurQuantity" runat="server" Text='<%#Eval("PurFullQty")%>' CssClass="classAlign" MaxLength="9" Enabled="false"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        <asp:Label ID="lblGrossPurQuantityTotal" runat="server" Text="0"></asp:Label>
                        </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <ItemTemplate>
                        <asp:TextBox ID="txtHalfPurQuantity" runat="server" Text='<%#Eval("PurHalfQty")%>' CssClass="classAlign" MaxLength="9" Enabled="false"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        <asp:Label ID="lblGrossPurQuantityHalfTotal" runat="server" Text="0"></asp:Label>
                        </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Area"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="90px" ControlStyle-Width="90px">
                          <ItemTemplate>
                            <asp:TextBox ID="txtPurArea" runat="server" Text='<%#Eval("PurArea")%>' CssClass="classAlign" MaxLength="12" Enabled="false"/>
                          </ItemTemplate>
                          <FooterTemplate>
                            <asp:Label ID="lblGrossPurArea" runat="server"  Text="0">
                            </asp:Label>
                          </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Full Piece*"  FooterStyle-HorizontalAlign="Right"   ControlStyle-Width="90px" HeaderStyle-Width="90px" >
                        <ItemTemplate>
                        <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Eval("FullQty")%>' AutoPostBack="true" OnTextChanged="txtQuantity_OnTextChanged" CssClass="classAlign" MaxLength="9"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Half Piece*"  FooterStyle-HorizontalAlign="Right"   ControlStyle-Width="90px" HeaderStyle-Width="90px" >
                        <ItemTemplate>
                        <asp:TextBox ID="txtHalfQuantity" runat="server" Text='<%#Eval("HalfQty")%>' AutoPostBack="true" OnTextChanged="txtHalQty_OnTextChanged" CssClass="classAlign" MaxLength="9"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        <asp:Label ID="lblGrossQuantityHalfTotal" runat="server" Text="0"></asp:Label>
                         ...
                         <asp:TemplateField HeaderText="Area*"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="90px" ControlStyle-Width="90px">
                          <ItemTemplate>
                            <asp:TextBox ID="txtArea" runat="server" Text='<%#Eval("Area")%>' AutoPostBack="true" OnTextChanged="txtArea_OnTextChanged" CssClass="classAlign" MaxLength="12"/>
                          </ItemTemplate>
                          <FooterTemplate>
