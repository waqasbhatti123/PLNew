<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="GradingCardView.aspx.cs" Inherits="RMS.GradingCardView" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <td>
   ...
   <ContentTemplate>
      ...
      <asp:GridView ID="GridView1" runat="server" Width="60%" Enabled="false" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
      ...
      <FooterTemplate>
        ...
        <asp:TemplateField HeaderText="Area *"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="100px" ControlStyle-Width="100px">
          <ItemTemplate>
            <asp:TextBox ID="txtWeight" runat="server" Text='<%#Eval("Weight")%>' CssClass="classAlign"  Width="100px" />
          </ItemTemplate>
          <FooterTemplate>
