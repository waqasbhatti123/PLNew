<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="MaterialPurchaseNoteViewNew.aspx.cs" Inherits="RMS.MaterialPurchaseNoteViewNew" %>
              ...
              <td>
                            ...
                            <asp:GridView ID="grdIGPs" runat="server" 
                                    ...
                                    <Columns>
                                        ...
                                        <ItemTemplate>
                                        <asp:CheckBox ID="cbxSelectIGP" runat="server" ToolTip="Select IGP to merge." />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                        <asp:LinkButton ID="lnkMergIgps" runat="server" Text="Merge" OnClick="LnkMergIgps_Click" ToolTip="Merge IGPs." Font-Bold="true" Font-Underline="false" CssClass="lnk">
                                        </asp:LinkButton>
                                        </FooterTemplate>
                                        </asp:TemplateField>
              ...
              <table  cellspacing="2" class="stats2" align="center" border="0" width="98%">
                    <tr>
                      ...
                      <tr valign="top">
                                ...
                                <td>
                                             <asp:TextBox ID="txtCommission" runat="server" CssClass="classOnlyInt" Width="74px">
                                            </asp:TextBox>
                                </td>
                                <td class="LblBgSetup">
        ...
        <br />
                        ...
                        <asp:GridView ID="GridView1" runat="server"  Width="100%" OnRowDataBound="GridView1_RowDataBound" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" >
                          ...
                          <asp:TemplateField HeaderText="Amount"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"  ControlStyle-Width="80px">
                              <ItemTemplate>
                                <asp:TextBox ID="txtAmount" runat="server" Text='<%#Eval("Amount")%>' Enabled="false" BorderColor="ActiveBorder" BorderWidth="1" BorderStyle="Solid" BackColor="#F2F2F2" />
                              </ItemTemplate>
                              <FooterTemplate>
