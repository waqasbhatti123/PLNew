<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="CrustDeptTrnsfrMgt.aspx.cs" Inherits="RMS.CrustDeptTrnsfrMgt" %>
              ...
              <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  Width="50%" GridLines="None" AutoGenerateColumns="false" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound" EmptyDataText="No record found.">
                      ...
                      <Columns>
                        ...
                        <ItemTemplate>
                        <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Eval("FullQty")%>' CssClass="classAlign" MaxLength="6"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        ...
                        <ItemTemplate>
                        <asp:TextBox ID="txtHalfQuantity" runat="server" Text='<%#Eval("HalfQty")%>' CssClass="classAlign" MaxLength="6"/>
                        </ItemTemplate>
                        <FooterTemplate>
                        <asp:Label ID="lblGrossQuantityHalfTotal" runat="server" Text="0"></asp:Label>
                         ...
                         <asp:TemplateField HeaderText="Area*"  FooterStyle-HorizontalAlign="Right" HeaderStyle-Width="90px" ControlStyle-Width="90px">
                          <ItemTemplate>
                            <asp:TextBox ID="txtArea" runat="server" Text='<%#Eval("Area")%>' CssClass="classAlign" MaxLength="7"/>
                          </ItemTemplate>
                          <FooterTemplate>
