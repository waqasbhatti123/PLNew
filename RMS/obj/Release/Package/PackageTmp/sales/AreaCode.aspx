...
CodeBehind="AreaCode.aspx.cs" Inherits="RMS.sales.AreaCode"  %>
                          ...
                          <td>
                                    <table>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDescription" runat="server" CssClass="RequiredField" TextMode="MultiLine"  onkeyup="LimitText(this,100);" onblur="LimitText(this,100);" Width="400" Height="40"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td class="LblBgSetup">
                                                <asp:Label ID="Label5" runat="server" Text="Distributor:" Width="110"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtDistr" runat="server" CssClass="RequiredField" TextMode="MultiLine"  onkeyup="LimitText(this,100);" onblur="LimitText(this,100);" Width="400" Height="40"></asp:TextBox>
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDescription" Display="None" ErrorMessage="Enter description." SetFocusOnError="true" ValidationGroup="main"></asp:RequiredFieldValidator>   --%>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
              ...
              <tr>
                  ...
                  <td>
                            <table width="100%">
                                    ...
                                    <asp:Panel ID="pnlFilter" runat="server" DefaultButton="ImageButton1">
                                               <table class="filterTable" cellpadding="1" cellspacing="2" width="100%"><tr><td colspan="9">&nbsp;</td></tr>
                                                      <tr>
                                                        ...
                                                        <td>Description:</td>
                                                        <td>
                                                            <asp:TextBox runat="server" ID="txtFltDesc" Width="200px" MaxLength="50" class="filter"></asp:TextBox>
                                                        </td>
                                                        <td>Code Type:</td>
                                                        <td>
                                ...
                                <tr>
                                    <td>
                                              <asp:GridView ID="grdcode" runat="server" DataKeyNames="gl_cd, ct_id,codetype, headgl_cd" OnSelectedIndexChanged="grdcode_SelectedIndexChanged" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No record found." Width="100%" PageSize="25" OnPageIndexChanging="grdcode_PageIndexChanging" OnRowDataBound="grdcode_RowDataBound" OnDataBound="grdcode_DataBound" >
