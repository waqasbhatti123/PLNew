<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="SizingGradingCardMgt.aspx.cs" Inherits="RMS.SizingGradingCardMgt" %>
            ...
            <td width="3%">
                ...
                <td>
                            ...
                            <fieldset class="fieldSet" >
                                  ...
                                  <asp:ImageButton runat="server" ID="imgIGP" OnClick="srchIGP_Click" ValidationGroup="mainSrch" CssClass="Clk" ToolTip="Search by IGP No." ImageUrl="../images/search_icon.png" />
                                    </td>
                                  ...
                                  <asp:TextBox ID="txtCardDate" runat="server" CssClass="RequiredFieldTxtSmall">
                                  </asp:TextBox>
                                        ...
                                        <ContentTemplate>
                                          ...
                                          <asp:Label runat="server" ID="lblSr" Text='<%#Eval("Sr") %>' Width="20px" BackColor="White">
                                            ...
                                            <asp:TemplateField HeaderText="Area*"  FooterStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px" ControlStyle-Width="100px">
                                              <ItemTemplate>
                                                <asp:TextBox ID="txtWeight" runat="server" Text='<%#Eval("Weight")%>' CssClass="classAlign" MaxLength="7"/>
                                              </ItemTemplate>
                                              <FooterTemplate>
