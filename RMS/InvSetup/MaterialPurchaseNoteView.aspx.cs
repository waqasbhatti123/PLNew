...
namespace RMS
{
    public partial class MaterialPurchaseNoteView : BasePage
    {
        #region DataMembers
...
#pragma warning disable CS0414 // The field 'MaterialPurchaseNoteView.count' is assigned but its value is never used
        int count;
#pragma warning restore CS0414 // The field 'MaterialPurchaseNoteView.count' is assigned but its value is never used
        ...
        public void BindRateFields()
        {
            try
            {
                ...
                int count=0;
                string obj = mN.GetItemUzngLot4mItemData4Cancel(ltNo, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
