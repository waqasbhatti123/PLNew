...
namespace RMS
{
    public partial class CrustDeptTrnsfrMgt : BasePage
    {
        #region DataMembers
        ...
        protected void ddlItem_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (lst.Count > 0)
            {
                ...
                {
                    SumHalfQty = SumHalfQty + Convert.ToInt32(lst[i].itm_op_half) + Convert.ToInt32(lst[i].itm_pur_half) - Convert.ToInt32(lst[i].itm_isu_half);
                    SumFullQty = SumFullQty + Convert.ToInt32(lst[i].itm_op_qty) + Convert.ToInt32(lst[i].itm_pur_qty) - Convert.ToInt32(lst[i].itm_isu_qty);
                }
        ...
        public void BindEditTable()
        {
            ...
            txtStkHalf.Text = Convert.ToString(SumHalfQty - halfPending + vrHalfQty);
            txtStkFull.Text = Convert.ToString(SumFullQty - fullPending + vrFullQty);
        }
