...
namespace RMS
{
    public partial class CrustDeptTrnsfrHome : BasePage
    {
        #region DataMembers

        CrustDeptTrnsfrMgt mgt = new CrustDeptTrnsfrMgt();
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            Session["PrePgAddress"] = "~/invsetup/crustdepttrnsfrhome.aspx?PID=426";
            Session["PgTile"] = "CrustDeptTrnsfrEdit";
            Response.Redirect("~/invsetup/crustdepttrnsfrmgt.aspx?PID=443");
        }
        ...
        protected void lnkView_Click(object sender, EventArgs e)
        {
            ...
            Session["DateYear"] = DateYr;
            Session["PrePgAddress"] = "~/invsetup/crustdepttrnsfrhome.aspx?PID=426";
            Session["PgTile"] = "CrustDeptTrnsfrView";
            Response.Redirect("~/invsetup/crustdepttrnsfrview.aspx?PID=446");
        }
