...
namespace RMS
{
    public partial class SizingGradingCardMgt2 : BasePage
    {
        #region DataMembers
...
#pragma warning disable CS0414 // The field 'SizingGradingCardMgt2.flagClear' is assigned but its value is never used
        bool flagClear = false;
#pragma warning restore CS0414 // The field 'SizingGradingCardMgt2.flagClear' is assigned but its value is never used
        #endregion
                    ...
                    //igpNo = Convert.ToInt32(txtSrcIGP.Text.Substring(0, 4)+txtSrcIGP.Text.Substring(5));
                        ...
                        if (exist == false)
                        {
                            ...
                            if (ifIGPApproved == false)
                            {
                                ...
                                //txtGpDate.Text = txtCardDate.Text;

                                BindGridIGP();
                                //for (int i = 0; i < grdIGP.Rows.Count; i++)
                                //{
                                //    sumQuantity = sumQuantity + Convert.ToInt32(grdIGP.Rows[i].Cells[3].Text);
                                //}
                                //txtLotQty.Text = sumQuantity.ToString();
                            }
                            else
                            {
       ...
       //====================== 
        ...
        public void Edit()
        {
            try
            {
                ...
                if (sum == Convert.ToInt32(txtLotQty.Text))
                {
