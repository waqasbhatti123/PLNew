<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="DispatchHome.aspx.cs" Inherits="RMS.DispatchHome" %>
                ...
                <asp:TemplateField HeaderText="Options"  HeaderStyle-Width="150px">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="Label1" runat="server"  Visible="false" Text='<%# Bind("fromLoc") %>'>'></asp:Label>
                         ...
                         <asp:LinkButton ID="lnkCancelAfterApprove" runat="server"  Text="Cancel" OnClick="lnkCancelAfterApprove_Click" Visible="false" OnClientClick="return promptFunc()"></asp:LinkButton>
