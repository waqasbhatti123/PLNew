<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="MaterialTrnsfrNtHome.aspx.cs" Inherits="RMS.MaterialTrnsfrNtHome" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <br />
        ...
        <asp:ImageButton ID="btnCreate" runat="server"  ImageUrl="~/images/btn_generate.png" OnCommand="btnCreate_Click"
 ...
 <br />
  <p>
        ...
        <HeaderStyle CssClass ="grid_hdr" />
            ...
            <Columns>
                <asp:BoundField DataField="vr_no" HeaderText="Mat.Note No" />
                <asp:BoundField DataField="LotNo" HeaderText="Lot No" />
               <asp:BoundField DataField="vr_dt" DataFormatString= "{0:dd-MMM-yy}" htmlencode="false" HeaderText="Mat. Note Date" />
