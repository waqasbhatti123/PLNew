...
namespace RMS
{
    public partial class MaterialTrnsfrNtHome : BasePage
    {
        #region DataMembers
        ...
        protected void lnkApprove_Click(object sender, EventArgs e)
        {
            ...
            bool res = mN.ChngedSG_Status(sgNo, Convert.ToInt32(vrno.Text.Substring(0, 4)), 23, 'A', uzrName, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            BindGridSG();
            if (res == true)
            {
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            Session["PrePgAddress"] = "~/invsetup/materialtrnsfrnthome.aspx?PID=423";
            Session["PgTile"] = "MatTrnsfrNtEdit";
            Response.Redirect("~/invsetup/materialtrnsfrntmgt.aspx?PID=429");
        }
        ...
        protected void lnkView_Click(object sender, EventArgs e)
        {
            ...
            Session["IfEdit"] = true;
            Session["PrePgAddress"] = "~/invsetup/materialtrnsfrnthome.aspx?PID=423";
            Session["PgTile"] = "MatTrnsfrNtView";
            Response.Redirect("~/invsetup/materialtrnsfrntview.aspx?PID=430");
        }
        ...
        protected void lnkCancel_Click(object sender, EventArgs e)
        {
            ...
            bool res = mN.ChngedSG_Status(sgNo, Convert.ToInt32(vrno.Text.Substring(0,4)), 23, 'C', uzrName, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            BindGridSG();
            if (res == true)
            {
        ...
        public void BindGridSG()
        {
            try
            {
                grdIGP.DataSource = mN.GetGrid_Records(Convert.ToDateTime(txtfromDt.Text), Convert.ToDateTime(txttoDt.Text), 23, Convert.ToChar(ddlStatus.SelectedValue), (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
                grdIGP.DataBind();
            }
            catch (Exception ex)
            {
