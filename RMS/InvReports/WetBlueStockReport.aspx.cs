...
namespace RMS
{
    public partial class WetBlueStockReport : BasePage
    {
        #region DataMembers
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (PID == 453)
                {
                    Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "WetBlueStockReport").ToString();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            reportViewer.LocalReport.ReportPath = "InvReports/rdlc/WetBlueStockRpt.rdlc";
            ...
            //List<sp_StkStatusResult> wetBlueStock = rptBl.GetWetBlueStkStatus(fromDt, toDt, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);


            ReportDataSource dataSource = new ReportDataSource("sp_StkStatusResult", "");//wetBlueStock);

            ReportParameter[] rpt = new ReportParameter[3];
            rpt[0] = new ReportParameter("ReportName", "Wet Blue Stock Status Report");
            ...
            filename = string.Format("{0}.{1}", "WetBlueStockStatus", "pdf");
