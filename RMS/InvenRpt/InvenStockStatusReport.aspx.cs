...
namespace RMS
{
    public partial class InvenStockStatusReport : BasePage
    {
        #region DataMembers
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportViewer.LocalReport.ReportPath = "InvenRpt/rdlc/StockStatus.rdlc";
                ...
                List<sp_InvStatusResult> Stock = rptBl.GetInvenStockStatus(BrId, ddlItemGroup.SelectedValue, Convert.ToDecimal(ddlLoc.SelectedValue), fromDt, toDt,txtcodefrom.Text, txtcodeto.Text, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);


                ReportDataSource dataSource = new ReportDataSource("sp_InvStatusResult", Stock);

                ReportParameter[] rpt = new ReportParameter[3];
                rpt[0] = new ReportParameter("ReportName", "Stock Status Report");
                ...
                filename = string.Format("{0}.{1}", "StockStatus", ext);
