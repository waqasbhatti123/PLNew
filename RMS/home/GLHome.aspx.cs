...
namespace RMS.home
{
    public partial class GLHome : BasePage
    {
        #region DataMembers
        ...
        public static object[] GetChartEmpSalariesinPrevMonthData()
        {
            ...
            {
                int actMonthObj = dc.TblSalaryMonths.Where(x => x.MonthIsActive == true && x.BranchID == BranchID).FirstOrDefault().MonthID;
        ...
        public static object[] GetAppIncoGranttackChart()
        {
            ...
            using (RMSDataContext dc = new RMSDataContext())
            {
                ...
                {
                    j++;
                    chartData[j] = new object[] { i.br_nme.ToString(), i.income, i.grantt };
                }
