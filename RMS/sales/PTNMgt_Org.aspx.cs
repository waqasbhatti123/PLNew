...
namespace RMS.sales
{
    public partial class PTNMgt_Org : BasePage
    {
        ...
        DataRow d_Row;
        DataColumn d_Col;
        short VoucherTypeCode = 31; // voucher type code 31 for Production Note in Vr_Type table
        ...
        private bool Save()
        {
           ...
           // stkData.DeptId = Convert.ToInt16(ddlDept.SelectedValue);
            ...
            string itemCode, uomitem, trqty, rcdqty, batch, rem;
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                        ...
                        && !rcdqty.Equals(""))
                {
                    ...
                    stkDataDet.vr_qty_Rej = Convert.ToDecimal(trqty) - Convert.ToDecimal(rcdqty);
