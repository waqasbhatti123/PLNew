...
namespace RMS.sales
{
    public partial class RptConsSalesReport : System.Web.UI.Page
    {
        #region DataMember
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "ConsSalesReport").ToString();
        ...
        protected void GenerateReport(string reportName)
        {
            ...
            List<spPartyWiseSaleConsRptResult> recs;
            recs = slBL.GetConsolidatedSalesRpt(BrId, ddlVendor.SelectedValue, fromDate, toDate, ddlStatus.SelectedValue, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);

            viewer.LocalReport.ReportPath = "sales/rdlc/ConsSalesRpt.rdlc";

            ReportDataSource datasource = new ReportDataSource("spPartyWiseSaleConsRptResult", recs);
