<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="SOMgt.aspx.cs" Inherits="RMS.sales.SOMgt" Culture="auto" UICulture="auto"
...
<script type="text/javascript">
    ...
    function pageLoad() {
        ...
        $("[id*=GridView1][id*=ddlItem]").each(function() {
            if ($(this).val() != '0') {
                if ($('#<%= hdnPID.ClientID %>').val() == '921') {
                    ValidatorEnable($(this).closest('tr').find('[id*=reqOrderQty]')[0], true);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqRate]')[0], true);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqQty]')[0], true);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqDate]')[0], true);
                }
                else if ($('#<%= hdnPID.ClientID %>').val() == '922') {
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqQty]')[0], true);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqDate]')[0], true);
                }
                var gRow = $(this);
                ...
                if ($('#<%= hdnPID.ClientID %>').val() == '921') {
                    ...
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqQty]')[0], false);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqDate]')[0], false);
                }
                else if ($('#<%= hdnPID.ClientID %>').val() == '922') {
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqQty]')[0], false);
                    ValidatorEnable($(this).closest('tr').find('[id*=reqReqDate]')[0], false);
        ...
        $.ajax({
            ...
            success: function(heads) {
                ...
                if (heads.length > 0) {
                    ...
                    if ($('#<%= hdnPID.ClientID %>').val() == '921') {
                        gRow.closest('tr').find("[id*=ddlGST]").val(heads[0].gstid);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqOrderQty]')[0], true);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqRate]')[0], true);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqQty]')[0], true);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqDate]')[0], true);
                    }
                    else if ($('#<%= hdnPID.ClientID %>').val() == '922') {
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqQty]')[0], true);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqDate]')[0], true);
                    ...
                    if ($('#<%= hdnPID.ClientID %>').val() == '921') {
                        ...
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqQty]')[0], false);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqDate]')[0], false);
                    }
                    else if ($('#<%= hdnPID.ClientID %>').val() == '922') {
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqQty]')[0], false);
                        ValidatorEnable(gRow.closest('tr').find('[id*=reqReqDate]')[0], false);
                ...
                <table class="tblMain" cellspacing="0" cellpadding="0">
                    <asp:Panel runat="server" ID="pnlMain">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="true" Width="120px">
                                </asp:DropDownList>
                        ...
                        <tr>
                           <td class="tdlabel">
                            ...
                            <td>
                                <asp:TextBox ID="txtReqNo" runat="server" ReadOnly="true"  Width="80px" TabIndex="-1">
                                </asp:TextBox>
                            </td>
                            <td class="tdlabel">
                        ...
                        <tr>
                            ...
                            <asp:Panel ID="pnlWHT" runat="server">
                            <td class="tdlabel">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="t_grd" OnRowDataBound="GridView1_RowDataBound">
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="Order Quantity">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtReqQty" runat="server" Text='<%#Eval("ReqQty") %>' Width="60px" style="text-align:right"/>
                                                    <asp:RequiredFieldValidator ID="reqReqQty" runat="server" Display="Dynamic" ValidationGroup="main" CssClass="validateGridView"
                                                        ControlToValidate="txtReqQty" ErrorMessage="Order Quantity required" Enabled="false"></asp:RequiredFieldValidator>
                                                    <asp:RangeValidator runat="server" ID="rvReqQ" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Invalid/Out of range Order Quantity"
                                                        ControlToValidate="txtReqQty" MinimumValue="1.00" MaximumValue="999999999.99" Type="Double" Display="Dynamic" SetFocusOnError="true"></asp:RangeValidator>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                              ...
                                              <asp:TemplateField HeaderText="Confirmed Quantity">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtOrderQty" runat="server" Text='<%#Eval("OrderQty") %>' Width="60px" style="text-align:right"/>
                                                    <asp:RequiredFieldValidator ID="reqOrderQty" runat="server" Display="Dynamic" ValidationGroup="main" CssClass="validateGridView"
                                                        ControlToValidate="txtOrderQty" ErrorMessage="Confirmed Quantity required" Enabled="false"></asp:RequiredFieldValidator>
                                                    <asp:RangeValidator runat="server" ID="rvTQ" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Invalid/Out of range Confirmed Quantity"
                                              ...
                                              <asp:TemplateField HeaderText="GST">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlGST" runat="server" AppendDataBoundItems="true" Width="120px">
                                              ...
                                              <asp:TemplateField HeaderText="Due Date">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtReqDate" runat="server" Text='<%#Eval("ReqDate") %>' Width="60px"/>
                                                    <asp:RequiredFieldValidator ID="reqReqDate" runat="server" Display="Dynamic" ValidationGroup="main" CssClass="validateGridView"
                                                        ControlToValidate="txtReqDate" ErrorMessage="Due Date required" Enabled="false"></asp:RequiredFieldValidator>
                                                    <ajaxToolkit:CalendarExtender ID="calReqDate" runat="server" TargetControlID="txtReqDate" Format="dd-MMM-yy" PopupPosition="BottomRight" >
                                                    </ajaxToolkit:CalendarExtender>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                              ...
                                              <asp:TemplateField HeaderText="Sch. Date">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtSchDate" runat="server" Text='<%#Eval("SchDate") %>' Width="60px"/>
                                                    <ajaxToolkit:CalendarExtender ID="calSchDate" runat="server" TargetControlID="txtSchDate" Format="dd-MMM-yy" PopupPosition="BottomRight" >
                                                    </ajaxToolkit:CalendarExtender>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                              ...
                                              <asp:TemplateField HeaderText="Remarks">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtRemarks" runat="server" Text='<%#Eval("Rem")%>' Width="100px" MaxLength="70"/>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
