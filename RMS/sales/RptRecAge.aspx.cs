...
namespace RMS.sales
{
    public partial class RptRecAge : System.Web.UI.Page
    {
        #region DataMember
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "AgeingOfRecReport").ToString();
        ...
        protected void GenerateReport(string reportName)
        {
            ...
            List<spAgeingOfReceivableRptResult> recs;
            recs = slBL.GetAgeingOfRec(BrId, ddlVendor.SelectedValue, fromDate, toDate, "", (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);

            viewer.LocalReport.ReportPath = "sales/rdlc/AgeingOfRecRpt.rdlc";

            ReportDataSource datasource = new ReportDataSource("spAgeingOfReceivableRptResult", recs);
