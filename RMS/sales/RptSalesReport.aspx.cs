...
namespace RMS.sales
{
    public partial class RptSalesReport : System.Web.UI.Page
    {
        #region DataMember
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "SalesReport").ToString();
        ...
        protected void GenerateReport(string reportName)
        {
            ...
            List<spPartyWiseSaleRptResult> recs;
            recs = slBL.GetSalesRpt(BrId, ddlVendor.SelectedValue, fromDate, toDate, ddlStatus.SelectedValue, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            
            viewer.LocalReport.ReportPath = "sales/rdlc/SalesRpt.rdlc";

            ReportDataSource datasource = new ReportDataSource("spPartyWiseSaleRptResult", recs);
