<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="PTNMgt.aspx.cs" Inherits="RMS.sales.PTNMgt" Culture="auto" UICulture="auto"
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="t_grd" OnRowDataBound="GridView1_RowDataBound">
                                            ...
                                            <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="Remarks">
                                                  <ItemTemplate>
                                                    <asp:TextBox ID="txtRemarks" runat="server" Text='<%#Eval("Rem")%>' Width="280" MaxLength="100"/>
                                                  </ItemTemplate>
                                                  <ControlStyle />
                                                  <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                  <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" Width="280px"/>
                                              </asp:TemplateField>
                                          </Columns>
                                        </asp:GridView>
                                        </td>
