<%@ Page Language="C#" MasterPageFile="~/home/RMSMasterHome.Master" AutoEventWireup="true"
    CodeBehind="STNMgt.aspx.cs" Inherits="RMS.Inv.STNMgt" Culture="auto" UICulture="auto"
...
//                ValidatorEnable($(this).closest('tr').find('[id*=reqQtyAck]')[0], false);
        ...
        $("[id*=GridView1]input[type=text][id*=txtIssueBal]").each(function() {
            $(this).attr("readonly", true);
        });
    ...
    function FillItemDetailFields(gRow) {
        ...
        var locid = $("#<%= ddlLoc.ClientID %>").val();
        if (locid == '0') {
            alert("Please select from location");
            $("#<%= ddlLoc.ClientID %>").focus();
            return;
        }
       $.ajax({
       url: "STNMgt.aspx/GetItemDetail",
           data: JSON.stringify({ itemid: itemid, locid: locid }),
           type: 'POST',
           ...
           success: function(heads) {
               ...
               if (heads.length > 0) {
                   ...
                   gRow.closest('tr').find("input[type=text][id*=txtIssueBal]").val(heads[0].stkqty);
...
//                   ValidatorEnable(gRow.closest('tr').find('[id*=reqQtyAck]')[0], true);
                   ...
                   gRow.closest('tr').find("input[type=text][id*=txtIssueBal]").val('');
                            ...
                            <td>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Quantity On Hand">
                                      <ItemTemplate>
                                        <asp:TextBox ID="txtIssueBal" runat="server" Text='<%#Eval("QtyIssueBal") %>' Width="60px" TabIndex="-1"  style="text-align:right"/>
                                        <asp:RangeValidator runat="server" ID="rvIB" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Invalid/Out of range Quantity On Hand"
                                            ControlToValidate="txtIssueBal" MinimumValue="0.001" MaximumValue="99999999999.99" Type="Double" Display="Dynamic" SetFocusOnError="true"></asp:RangeValidator>
                                      </ItemTemplate>
                                      <ControlStyle />
                                      <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                      <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" Width="60px"/>
                                    ...
                                    <asp:TemplateField HeaderText="Quantity Issued">
                                      <ItemTemplate>
                                         <asp:TextBox ID="txtQtyIss" runat="server" Text='<%#Eval("QtyIssued")%>' MaxLength="9" Width="60px"  style="text-align:right"/>
                                         ...
                                         <asp:CompareValidator runat="server" ID="cvQI" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Quantity Issued must be less than equal to Quantity On Hand"
                                            ControlToValidate="txtQtyIss" ControlToCompare="txtIssueBal" Type="Double" Operator="LessThanEqual" Display="Dynamic" SetFocusOnError="true"></asp:CompareValidator>
                                      </ItemTemplate>
                                      <ControlStyle />
                                      <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center"/>
                                      <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" Width="60px"/>
                                    ...
                                    <asp:TemplateField HeaderText="Quantity ACK" HeaderStyle-CssClass="DisplayNone" FooterStyle-CssClass="DisplayNone" ItemStyle-CssClass="DisplayNone" ControlStyle-CssClass="DisplayNone">
                                      <ItemTemplate>
                                        ...
                                        <asp:RangeValidator runat="server" ID="rvQA" Enabled="false" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Invalid/Out of range Quantity ACK"
                                            ControlToValidate="txtQtyAck" MinimumValue="1.00" MaximumValue="999999999.99" Type="Double" Display="Dynamic" SetFocusOnError="true"></asp:RangeValidator>
                                        <asp:CompareValidator runat="server" Enabled="false" ID="cvQA" CssClass="validateGridView" ValidationGroup="main" ErrorMessage="Quantity ACK must be equal to Quantity Issued"
            ...
            <td valign="top">
                ...
                <table class="filterTable" width="70%">
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton ID="btnSearch" runat="server" Enabled="false" ImageUrl="~/images/search-icon-blue.gif"
