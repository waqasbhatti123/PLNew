...
CodeBehind="ItemCode.aspx.cs" Inherits="RMS.Inv.ItemCode"  %>
...
<script type="text/javascript">
    function pageLoad() {
        ...
        //Purchase Issue A/C
        /**************************************************/
        $('#<%= txtPurchaseAcc.ClientID %>').click(function(event) {
            this.select();
        });
        $('#<%= txtIssueAcc.ClientID %>').click(function(event) {
            this.select();
        });
        $('#<%= txtPurchaseAcc.ClientID %>').autocomplete({

            source: function(request, response) {
                $.ajax({
                    url: "ItemCode.aspx/GetPurchaseIssueAccount",
            ...
            select: function(e, ui) {
                //alert(ui.item.id);
                $('#<%= hdnPurchaseAcc.ClientID %>').val(ui.item.id);
            },

            minLength: 1
        });
        $('#<%= txtIssueAcc.ClientID %>').autocomplete({
            ...
            select: function(e, ui) {
                //alert(ui.item.id);
                $('#<%= hdnIssueAcc.ClientID %>').val(ui.item.id);
            },

            minLength: 1
        });
        /**************************************************/
        //End Of Purchase Issue A/C
        /**************************************************/
                                    ...
                                    <table>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                             ...
                                             <table><tr>
                                             <td class="LblBgSetup">
                                                <asp:Label ID="Label5" runat="server" Text="UOM:" Width="50"></asp:Label>
                                            </td>
                                             <td>
                                                ...
                                                <td class="LblBgSetup">
                                                    <asp:Label ID="Label14" runat="server" Text="Item:" Width="50" Visible="false"></asp:Label>
                                                    <asp:Label ID="Label15" runat="server" Text="Item Group:" ></asp:Label>
                                                </td>
                                                 <td>
                                                    <asp:DropDownList ID="ddlItemType" runat="server" Enabled="false" Visible="false">
                                                        <asp:ListItem Value="UG" Selected="True">General</asp:ListItem>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="reqItemGroup" runat="server" ControlToValidate="ddlItemGroup" Display="None" ErrorMessage="Select item group." SetFocusOnError="true" ValidationGroup="main" InitialValue="0"></asp:RequiredFieldValidator>   
                                                </td>
                                        ...
                                        <tr valign="top">
                                            <td class="LblBgSetup">
                                                <asp:Label ID="Label16" runat="server" Text="Purchase A/C:" Width="110"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtPurchaseAcc" runat="server" TextMode="MultiLine" Width="180"></asp:TextBox>
                                                <asp:HiddenField ID="hdnPurchaseAcc" runat="server" />
                                            </td>
                                            <td class="LblBgSetup">
                                                <asp:Label ID="Label17" runat="server" Text="Issue A/C:" Width="110"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtIssueAcc" runat="server" TextMode="MultiLine" Width="180"></asp:TextBox>
                                                <asp:HiddenField ID="hdnIssueAcc" runat="server" />
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <td class="LblBgSetup">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCode" runat="server" CssClass="RequiredField" ReadOnly="true" TabIndex="-1" Width="120"></asp:TextBox>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox ID="txtDescription" runat="server" CssClass="RequiredField" TextMode="MultiLine" Width="480px" Height="80px" onkeyup="LimitText(this,500);" onblur="LimitText(this,500);"></asp:TextBox>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox ID="txtSpecs" runat="server" TextMode="MultiLine" Width="480px" Height="80px"  onkeyup="LimitText(this,500);" onblur="LimitText(this,500);"></asp:TextBox>
                                            </td>
                                        </tr>
                                       <tr valign="top">
                                            <td   class="LblBgSetup">
              ...
              <tr>
                  ...
                  <td>
                            <table width="100%">
                                ...
                                <tr>
                                    <td>
                                            <asp:Panel ID="pnlFltr" runat="server" DefaultButton="ImageButton1">
                                    ...
                                    <td>
                                              <asp:GridView ID="grdcode" runat="server" DataKeyNames="itm_cd, ct_id, ct_typ, hdcode" OnSelectedIndexChanged="grdcode_SelectedIndexChanged" AutoGenerateColumns="False" AllowPaging="True" EmptyDataText="No record found." Width="100%" PageSize="25" OnPageIndexChanging="grdcode_PageIndexChanging" OnRowDataBound="grdcode_RowDataBound" OnDataBound="grdcode_DataBound" >
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="itm_grp_desc" HeaderText="Item Group" />
