...
namespace RMS.Inv
{
    public partial class PORevMgt : BasePage
    {
        #region DataMembers
...
#pragma warning disable CS0114 // 'PORevMgt.ID' hides inherited member 'Page.ID'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        public int ID
#pragma warning restore CS0114 // 'PORevMgt.ID' hides inherited member 'Page.ID'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["PageTitle"] = GetGlobalResourceObject("PageTitlesResource", "PORevMgt").ToString();
...
#pragma warning restore CS0472 // The result of the expression is always 'true' since a value of type 'int' is never equal to 'null' of type 'int?'
        ...
        {
            Response.Redirect("~/inv/porevmgt.aspx?PID="+PID);
        }
        ...
        private bool SavePO()
        {
            ...
            /////////////////////////////////////////////////////////////
            tblPOrder porder = new tblPOrder();
            ...
            /***************************************/
            tblPOrder ord = poBL.GetByID(ID, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            porder.RevOf = ord.vr_id;
            porder.RevSeq = poBL.GetRevSeq(ord.vr_no, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            porder.Status = "Op";
            ord.Status = "Cl";
            /***************************************/
            try
            ...
            string msg = poBL.SavePurchRevFull(ord, porder, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            if (msg.Equals("Done"))
            {
        ...
        private void BindGridMain(string poNo, string partyNme)
        {
            ...
            grdPo.DataSource = poBL.GetPORevOrders(BrID, poNo, partyNme, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            grdPo.DataBind();
        }
        ...
        public void UpdateTable()
        {
            if (CurrentTable != null)
            {
                ...
                for (int i = 0; i < rowsCount; i++)
                {
                    ...
                    reqno = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtReqNo")).Text;
                    ...
                    gst = ((System.Web.UI.WebControls.DropDownList)GridView1.Rows[i].Cells[1].FindControl("ddlGST")).SelectedValue;
                    spec = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtSpec")).Text;
                    uom = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[4].FindControl("txtUomItem")).Text;
                    amnt = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtAmnt")).Text;
                    qty = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtQuantity")).Text;
                    poqty = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtPoQuantity")).Text;
                    rate = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtRate")).Text;
                    duedte = ((System.Web.UI.WebControls.TextBox)GridView1.Rows[i].Cells[3].FindControl("txtDueDate")).Text;
