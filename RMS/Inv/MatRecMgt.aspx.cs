...
namespace RMS.Inv
{
    public partial class MatRecMgt : BasePage
    {
...
#pragma warning disable CS0169 // The field 'MatRecMgt.uomqtycode' is never used
#pragma warning disable CS0169 // The field 'MatRecMgt.item' is never used
        string srNo, grdPoRef, item, itemCd, packs, unitsize, qty, uomqty, uomqtycode, qtyShort, qtyRej, rem;//uom, uomcode,
#pragma warning restore CS0169 // The field 'MatRecMgt.item' is never used
#pragma warning restore CS0169 // The field 'MatRecMgt.uomqtycode' is never used
        ...
        {
            Response.Redirect("~/inv/matrecmgt.aspx?PID=514");
        }
        ...
        public void GetMatRecDocNo()
        {
            ...
            DocNoFormated = matBL.GetDocNo(Convert.ToDateTime(txtDocDate.Text.Trim()), 16, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
        ...
        private void BindGridMain(string docNo, string igpNo, string vendorId, string status)
        {
            ...
            grdMatRec.DataSource = matBL.GetAllMatRecs(docNo, igpNo, vendorId, status, (RMSDataContext)Session[Session["UserID"] + "rmsDBObj"]);
            grdMatRec.DataBind();
        }
